...
- Enable memory from the tenant's Agent General Settings page for the per-agent
  memory/history tab (agents with their own memory toggle off remain stateless).
