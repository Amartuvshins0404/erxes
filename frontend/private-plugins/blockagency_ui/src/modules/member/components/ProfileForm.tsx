...
import { CertificateUpload } from './Certificate';
...
export const ProfileForm = () => {
  ...
  return (
    <Form {...form}>
      <form
        className="h-full flex flex-col gap-3 justify-between overflow-hidden"
        onSubmit={form.handleSubmit(onSubmit)}
      >
        <ScrollArea className='hide-scroll'>
          <div className="gap-3 grid grid-cols-2 flex-1">
        ...
        <Button
          type="submit"
          disabled={loading}
          className="w-1/4 flex-0 self-end"
        >
