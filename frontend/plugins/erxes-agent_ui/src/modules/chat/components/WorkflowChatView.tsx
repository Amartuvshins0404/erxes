...
import { IconExternalLink, IconPlayerPlay, IconSitemap } from '@tabler/icons-react';
...
export const WorkflowChatView = ({ workflow }: { workflow: IWorkflow | null }) => {
  const {
    runs,
    loading,
    refetch,
    startPolling,
    stopPolling,
  } = useWorkflowRuns(workflow?._id, 10);
